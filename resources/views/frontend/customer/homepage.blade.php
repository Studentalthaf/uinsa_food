...
<!-- REVOLUTION SLIDER -->			
				...
				<!-- START REVOLUTION SLIDER 5.0.7 fullwidth mode -->
					<div id="rev_slider_34_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
						<ul>	<!-- SLIDE  -->
							<li data-index="rs-129" data-transition="fade" data-slotamount="default" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7"  data-title="Ikan &nbsp; Bakar" data-description="Siap Menemani Hari-Hari mu">
								<!-- MAIN IMAGE -->
								<img src="{{ asset('frontend/images/banner2.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
								<!-- LAYER NR. 2 -->
                          ...
                          data-splitout="none" 
                          style="z-index: 6;">
                          <span class="small_title">Kami memiliki</span> <br> Menu &nbsp; Baru &nbsp; Ikan &nbsp;<span class="color">Bakar</span>
                       </h1>
								<!-- LAYER NR. 2 -->
                        <p class="tp-caption tp-resizeme"
                          ...
                          data-mask_out="x:0;y:0;s:inherit;e:inherit;" 
                          data-start="800"
                          style="z-index: 9;">Siap Menemani Hari-harimu!
                       ...
                       <a href="#" class="btn-common btn-white page-scroll">Beli Sekarang</a>
							...
							<li class="text-center" data-index="rs-130" data-transition="slideleft" data-slotamount="default" data-rotate="0"  data-title="Teman &nbsp; Roti" data-description="Siap Menemani Hari-harimu!">
								<img src="{{ asset('frontend/images/banner1.jpg') }}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <h1 class="tp-caption tp-resizeme" 
                          ...
                          data-splitout="none" 
                          style="z-index: 6;">
                          <span class="small_title">  Roti Sebagai Teman</span> <br> Rapat &nbsp; Dengan &nbsp; <span class="color">Isian &nbsp; Coklat Lumer</span>
                        </h1>
                        <p class="tp-caption tp-resizeme"
                          data-x="center" data-hoffset="15"
                          data-y="210" 
                          ...
                          data-start="1200"
                           style="z-index: 12;">
                          <a href="#specialities" class="btn-common btn-white page-scroll">Tentang &nbsp; Kami</a> &nbsp; <a href="#order-form" class="btn-common btn-orange page-scroll">Beli &nbsp; Sekaramg</a>
                       </div>  
							...
							<li class="text-right" data-index="rs-131" data-transition="slideleft"   data-rotate="0" data-title="Makanan &nbsp; Cepat Saji" data-description="Siap Menemani Hari-harimu!">
								<img src="{{ asset('frontend/images/b3.jpg') }}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <h1 class="tp-caption tp-resizeme" 
                          ...
                          data-splitout="none" 
                          style="z-index: 6;">
                          <span class="small_title">Tersedia</span> <br> Makanan &nbsp; Cepat Saji &nbsp; <span class="color">ENAK</span>
                        </h1>
                        <p class="tp-caption tp-resizeme"
                          data-x="right" data-hoffset="" 
                          data-y="210" 
